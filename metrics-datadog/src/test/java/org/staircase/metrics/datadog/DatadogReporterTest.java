...
public class DatadogReporterTest {
  ...
  public void reportsByteGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", (byte) 1, timestamp, tags);
  }
  ...
  public void reportsShortGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", (short) 1, timestamp, tags);
  }
  ...
  public void reportsIntegerGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", 1, timestamp, tags);
  }
  ...
  public void reportsLongGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", 1L, timestamp, tags);
  }
  ...
  public void reportsFloatGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", 1.1f, timestamp, tags);
  }
  ...
  public void reportsDoubleGaugeValues() throws Exception {
    ...
    gaugeTestHelper("gauge", 1.1, timestamp, tags);
  }
  ...
  public void reportsWithExpansions() throws Exception {
    DatadogReporter reporterWithExpansions = DatadogReporter
        ...
        .convertDurationsTo(TimeUnit.MILLISECONDS)
        .withTransport(transport)
        .withExpansions(EnumSet.of(DatadogReporter.Expansion.COUNT, DatadogReporter.Expansion.P95, DatadogReporter.Expansion.MEDIAN, DatadogReporter.Expansion.RATE_1_MINUTE))
        .build();
  ...
  private <T> Gauge<T> gauge(T value) {
    final Gauge<T> gauge = mock(Gauge.class);
