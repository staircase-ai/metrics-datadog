...
import org.staircase.metrics.serializer.JsonSerializer;
import org.staircase.metrics.serializer.Serializer;
...
public class HttpTransport implements Transport {
  ...
  public static class Builder {
    ...
    public void withProxy(String proxyHost, int proxyPort) {
  ...
  public static class HttpRequest implements Transport.Request {
    ...
    public void send() throws Exception {
      ...
      if (LOG.isDebugEnabled()) {
        String sb = "Sending HTTP POST request to " +
                this.transport.seriesUrl +
                ", uncompressed POST body length is: " +
                postBody.length();
        LOG.debug(sb);
